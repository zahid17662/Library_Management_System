...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Please search for a book first");
    ...
    try {
        ...
        // Update the book status and clear issue information
        pst = c.prepareStatement(
            "UPDATE `library`.`book` SET " +
            "`status` = 'NotIssued', " +    // Matches your schema
            "issuedate = NULL, " +          // Exact column name
            "duedate = NULL, " +            // Exact column name
            "studentid = NULL " +           // Exact column name
            "WHERE id = ?");
